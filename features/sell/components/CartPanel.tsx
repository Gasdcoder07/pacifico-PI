      ...
      <div className="flex flex-col min-h-0 min-w-0 h-full">
        ...
        >
          {cart.length === 0 ? (
            ...
            /* AnimatePresence gestiona el montaje y desmontaje con animación */
              ...
              {cart.map((item) => {
                ...
                return (
                  <motion.div
                    ...
                    className="relative flex flex-col rounded-lg border border-neutral-200 shadow-sm p-2 gap-2 group bg-white"
                  >
                    <div className="flex justify-between items-center gap-2">
                      ...
                      <motion.button
                        onClick={() =>
                          removeProductCompletely(product.inventario_id)
                        }
                    ...
                    <div className="mt-auto flex justify-between items-center gap-2">
                      <div className="flex gap-2">
                        ...
                        <motion.button
                          onClick={() =>
                            removeFromCart(item.product.inventario_id)
                          }
                          whileHover={{ scale: 1.1 }}
                          whileTap={{ scale: 0.9 }}
                          transition={{
