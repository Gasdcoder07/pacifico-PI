            ...
            <div className={`flex-1 overflow-auto ${scrollbarStyles}`}>
                ...
                <table className="w-full table-fixed">
                    <thead className="bg-white sticky top-0 z-10 text-left border-b border-neutral-200 whitespace-nowrap">
                        <tr>
                            <th className="w-28 px-5 py-3">Código</th>
                            <th className="w-[clamp(160px,28vw,320px)] px-5 py-3">Producto</th>
                            <th className="hidden xl:table-cell w-36 px-5 py-3">Categoría</th>
                            <th className="w-20 px-5 py-3">Stock</th>
                            <th className="hidden xl:table-cell w-36 px-5 py-3">Estatus</th>
                            <th className="w-28 px-5 py-3 text-right">Precio</th>
                        ...
                        {PRODUCTS.map((product: any) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td title={product.name} className="px-5 py-3 font-semibold truncate">
                                        {product.name}
                                    </td>
                                    <td className="hidden xl:table-cell px-5 py-3 text-neutral-600 text-sm">
