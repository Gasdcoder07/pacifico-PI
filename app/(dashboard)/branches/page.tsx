    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 flex flex-col gap-8">
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="relative w-full lg:w-2/3 min-h-[24rem] bg-gradient-to-tr from-cyan-600/40 to-cyan-400 rounded-2xl border-2 border-cyan-50 p-6 sm:p-8 flex flex-col justify-between overflow-hidden">
                    <div className="absolute bg-gradient-to-l from-cyan-50 to-cyan-50/20 w-56 h-56 -bottom-10 -right-10 blur-3xl animate-pulse pointer-events-none"/>
                    <div className="absolute bg-gradient-to-l from-cyan-50 to-cyan-50/20 w-64 h-64 -top-10 -left-10 blur-3xl animate-pulse pointer-events-none"/>
                    ...
                    <div className="relative z-10 w-full sm:w-[80%] backdrop-blur-3xl rounded-3xl p-6 sm:px-8 sm:py-12 shadow-2xl border border-white/20">
                        <h2 className="text-xl sm:text-2xl bg-clip-text text-transparent bg-gradient-to-r from-zinc-50 to-cyan-50 mb-2">
                ...
                <div className="relative w-full lg:w-1/3 bg-white/80 rounded-3xl p-6 sm:p-8 shadow-lg overflow-hidden flex flex-col justify-between">
                    ...
                    <h1 className="relative z-10 text-5xl sm:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-700 to-zinc-500/30">Top 3</h1>
