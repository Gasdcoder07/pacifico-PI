 ...
 *     description: Crea un usuario con rol de administrador (rol_id 3) en Supabase Auth mediante el trigger y actualiza su foto de perfil en la tabla de usuarios.
 *     tags:
 *       - Administradores
 *     requestBody:
 *       required: true
